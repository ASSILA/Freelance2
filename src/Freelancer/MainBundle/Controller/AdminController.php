...
use Freelancer\MainBundle\Entity\Admin;
use Freelancer\MainBundle\Form\AdminType;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerMainBundle:Admin')->findAll();

        return $this->render('FreelancerMainBundle:Admin:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FreelancerMainBundle:Admin:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerMainBundle:Admin')->find($id);
        ...
        return $this->render('FreelancerMainBundle:Admin:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FreelancerMainBundle:Admin:edit.html.twig', array(
            'entity'      => $entity,
