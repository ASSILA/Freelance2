...
use Freelancer\MainBundle\Entity\Cv;
use Freelancer\MainBundle\Form\CvType;
...
class CvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerMainBundle:Cv')->findAll();

        return $this->render('FreelancerMainBundle:Cv:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FreelancerMainBundle:Cv:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerMainBundle:Cv')->find($id);
        ...
        return $this->render('FreelancerMainBundle:Cv:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FreelancerMainBundle:Cv:edit.html.twig', array(
            'entity'      => $entity,
