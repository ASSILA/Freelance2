...
use Freelancer\MainBundle\Entity\Entreprise;
use Freelancer\MainBundle\Form\EntrepriseType;
...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerMainBundle:Entreprise')->findAll();

        return $this->render('FreelancerMainBundle:Entreprise:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FreelancerMainBundle:Entreprise:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerMainBundle:Entreprise')->find($id);
        ...
        return $this->render('FreelancerMainBundle:Entreprise:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FreelancerMainBundle:Entreprise:edit.html.twig', array(
            'entity'      => $entity,
