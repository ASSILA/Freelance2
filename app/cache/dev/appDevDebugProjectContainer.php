...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.freelancer' => 'getSonata_Admin_FreelancerService',
            ...
            'sonata.admin.jobowner' => 'getSonata_Admin_JobownerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'freelancer_web', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Freelancer\\MainBundle\\Entity'))), 'Freelancer\\MainBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('FreelancerMainBundle' => 'Freelancer\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a6d8e84113a977dcb391d3f7e9760cdbae112005445fb64b5e95e705af8942d1');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Freelancer\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Freelancer\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Freelancer\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Freelancer\\MainBundle\\Entity\\User');
    }
    ...
    protected function getPugxUser_Manager_OrmUserManagerService()
    {
        ...
        return $this->services['pugx_user.manager.orm_user_manager'] = new \PUGX\MultiUserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Freelancer\\MainBundle\\Entity\\User', $this->get('pugx_user.manager.user_discriminator'));
    }
    ...
    {
        return $this->services['pugx_user.manager.user_discriminator'] = new \PUGX\MultiUserBundle\Model\UserDiscriminator($this->get('session'), array('admin' => array('entity' => array('class' => 'Freelancer\\MainBundle\\Entity\\Admin', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'Freelancer\\MainBundle\\Form\\Type\\RegistrationAdminType', 'name' => 'admin_user_registration', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => 'FreelancerMainBundle:Registration:Admin.html.twig'), 'profile' => array('form' => array('type' => NULL, 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL)), 'freelancer' => array('entity' => array('class' => 'Freelancer\\MainBundle\\Entity\\Freelancer', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'Freelancer\\MainBundle\\Form\\Type\\RegistrationFreelancerType', 'name' => 'freelancer_user_registration', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => 'FreelancerMainBundle:Registration:Freelancer.html.twig'), 'profile' => array('form' => array('type' => 'Freelancer\\MainBundle\\Form\\FreelancerType', 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL)), 'jobowner' => array('entity' => array('class' => 'Freelancer\\MainBundle\\Entity\\Jobowner', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'Freelancer\\MainBundle\\Form\\Type\\RegistrationJobownerType', 'name' => 'jobowner_user_registration', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => 'FreelancerMainBundle:Registration:Jobowner.html.twig'), 'profile' => array('form' => array('type' => 'Freelancer\\MainBundle\\Form\\JobownerType', 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL))));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Freelancer\MainBundle\Redirection\AfterLoginRedirection A Freelancer\MainBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Freelancer\MainBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Freelancer\MainBundle\Redirection\AfterLogoutRedirection A Freelancer\MainBundle\Redirection\AfterLogoutRedirection instance.
     */
    protected function getRedirect_After_LogoutService()
    {
        return $this->services['redirect.after.logout'] = new \Freelancer\MainBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminS');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register/admin$');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/freelancer');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/jobowner');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entreprise');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/jobowner');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/freelancer');
        ...
        $p->add($i, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $p->add($j, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $p->add($k, array(0 => 'ROLE_FREELANCER'), NULL);
        $p->add($l, array(0 => 'ROLE_JOBOWNER'), NULL);
        $p->add($m, array(0 => 'ROLE_ADMIN'), NULL);
        $p->add($n, array(0 => 'ROLE_JOBOWNER'), NULL);
        $p->add($o, array(0 => 'ROLE_FREELANCER'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $q, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/profile', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $s, array('check_path' => '/login_check', 'use_forward' => true, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57195e8747d2e', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $p, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $q, '/login', true), NULL, NULL, $a));
    }
     ...
     *
     * @return \Freelancer\MainBundle\admin\CvAdmin A Freelancer\MainBundle\admin\CvAdmin instance.
     */
    protected function getSonata_Admin_CvService()
    {
        $instance = new \Freelancer\MainBundle\admin\CvAdmin('sonata.admin.cv', 'Freelancer\\MainBundle\\Entity\\Cv', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('FreelancerMainBundle');
     ...
     *
     * @return \Freelancer\MainBundle\admin\EntrepriseAdmin A Freelancer\MainBundle\admin\EntrepriseAdmin instance.
     */
    protected function getSonata_Admin_EntrepriseService()
    {
        $instance = new \Freelancer\MainBundle\admin\EntrepriseAdmin('sonata.admin.entreprise', 'Freelancer\\MainBundle\\Entity\\Entreprise', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.freelancer' service.
     *
     * @return \Freelancer\MainBundle\admin\FreelancerAdmin A Freelancer\MainBundle\admin\FreelancerAdmin instance.
     */
    protected function getSonata_Admin_FreelancerService()
    {
        $instance = new \Freelancer\MainBundle\admin\FreelancerAdmin('sonata.admin.freelancer', 'Freelancer\\MainBundle\\Entity\\Freelancer', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.jobowner' service.
     *
     * @return \Freelancer\MainBundle\admin\JobownerAdmin A Freelancer\MainBundle\admin\JobownerAdmin instance.
     */
    protected function getSonata_Admin_JobownerService()
    {
        $instance = new \Freelancer\MainBundle\admin\JobownerAdmin('sonata.admin.jobowner', 'Freelancer\\MainBundle\\Entity\\Jobowner', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.entreprise', 1 => 'sonata.admin.freelancer', 2 => 'sonata.admin.jobowner', 3 => 'sonata.admin.projet', 4 => 'sonata.admin.cv'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.entreprise', 1 => 'sonata.admin.freelancer', 2 => 'sonata.admin.jobowner', 3 => 'sonata.admin.projet', 4 => 'sonata.admin.cv'))));
        $instance->setAdminClasses(array('Freelancer\\MainBundle\\Entity\\Entreprise' => array(0 => 'sonata.admin.entreprise'), 'Freelancer\\MainBundle\\Entity\\Freelancer' => array(0 => 'sonata.admin.freelancer'), 'Freelancer\\MainBundle\\Entity\\Jobowner' => array(0 => 'sonata.admin.jobowner'), 'Freelancer\\MainBundle\\Entity\\Projet' => array(0 => 'sonata.admin.projet'), 'Freelancer\\MainBundle\\Entity\\Cv' => array(0 => 'sonata.admin.cv')));
     ...
     *
     * @return \Freelancer\MainBundle\admin\ProjetAdmin A Freelancer\MainBundle\admin\ProjetAdmin instance.
     */
    protected function getSonata_Admin_ProjetService()
    {
        $instance = new \Freelancer\MainBundle\admin\ProjetAdmin('sonata.admin.projet', 'Freelancer\\MainBundle\\Entity\\Projet', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.entreprise', 1 => 'sonata.admin.freelancer', 2 => 'sonata.admin.jobowner', 3 => 'sonata.admin.projet', 4 => 'sonata.admin.cv'), $this);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Freelancer\\MainBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Freelancer\\MainBundle/Resources/views'), 'FreelancerMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('lskdjflsjdflksjdflizjefilzflsdjf');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_JOBOWNER' => array(0 => 'ROLE_USER'), 'ROLE_FREELANCER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FreelancerMainBundle' => 'Freelancer\\MainBundle\\FreelancerMainBundle',
            ...
            'locale' => 'fr',
            'secret' => 'lskdjflsjdflksjdflizjefilzflsdjf',
            ...
            'kernel.secret' => 'lskdjflsjdflksjdflizjefilzflsdjf',
            ...
            'fos_user.model.user.class' => 'Freelancer\\MainBundle\\Entity\\User',
