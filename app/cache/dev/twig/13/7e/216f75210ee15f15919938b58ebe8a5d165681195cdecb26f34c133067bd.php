...
/* FreelancerMainBundle:Freelancer:show.html.twig */
class __TwigTemplate_137e216f75210ee15f15919938b58ebe8a5d165681195cdecb26f34c133067bd extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("freelancer_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "FreelancerMainBundle:Freelancer:show.html.twig";
    }
