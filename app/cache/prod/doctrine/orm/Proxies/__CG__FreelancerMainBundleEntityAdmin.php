 ...
 */
class Admin extends \Freelancer\MainBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\Admin' . "\0" . 'lastLogin', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\Admin' . "\0" . 'email');
        }
