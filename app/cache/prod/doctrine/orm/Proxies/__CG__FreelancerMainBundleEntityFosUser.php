 ...
 */
class FosUser extends \Freelancer\MainBundle\Entity\FosUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'id', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'username', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'usernameCanonical', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'email', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'emailCanonical', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'enabled', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'salt', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'password', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'lastLogin', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'locked', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'expired', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'expiresAt', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'confirmationToken', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'passwordRequestedAt', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'roles', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'credentialsExpired', '' . "\0" . 'Freelancer\\MainBundle\\Entity\\FosUser' . "\0" . 'credentialsExpireAt');
        }
